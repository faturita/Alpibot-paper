...
\begin{figure} 
    \centering
  \subfloat[ \label{rww1a}]{%
       \includegraphics[width=0.97\linewidth]{images/Wft_5kg.eps}}
  \\
    \hspace*{-1.5em}
  \subfloat[ \label{rww1b}]{%
        \includegraphics[width=0.49\linewidth]{images/Wft_5kg_leader_robot_speed.eps}}
    \vspace*{-1.1em}
  \subfloat[ \label{rww1c}]{%
