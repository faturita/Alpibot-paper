...
\hline
\end{tabular}
\captionof{table}{Maximum trajectory deviation m.t.d. [m] and Total trajectory deviation t.t.d. for different Follow the thread constants.}
...
\hline
\end{tabular}
\captionof{table}{Maximum trajectory deviation m.t.d. (in [m]) and total trajectory deviation t.p.d. for different Rotate and go constants.}
...
\hline
\end{tabular}
\captionof{table}{Maximum trajectory deviation m.t.d. and area under normal trajectory deviation t.t.d. in motion capture experiments using Follow the thread.}
...
\end{tabular}
\captionof{table}{Maximum trajectory deviation m.t.d. and area under normal trajectory deviation t.p.d. in motion capture experiments using Rotate and go.}
