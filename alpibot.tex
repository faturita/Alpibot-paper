...
From the practical experiments, it is verified that both algorithms gave reasonable following performance in the task of following the leader along a lemniscate-shaped trajectory. This reasonable following behaviour is accomplished with a simple mechanism, a characteristic that significantly keep the price of the device low, putting it within reach of many medical institutions.
