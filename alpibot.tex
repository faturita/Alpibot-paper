...
\author{Luciano Bianchi, Esteban Buzniak, Rodrigo~Ramele,~\IEEEmembership{Member,~IEEE,}
...
Describe the PVC factoring process that Esteban created.  The materials and the name of the CNC that they are using to manufacture everything.  Add the components.
